...
Важно для работы с базой:

- у пользователя должна быть запись в таблице `users`
- в поле `login` должен быть указан Windows login пользователя
- если в базе нет вашего логина, добавьте пользователя перед началом работы
